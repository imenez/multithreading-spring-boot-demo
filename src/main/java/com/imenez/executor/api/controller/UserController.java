package com.imenez.executor.api.controller;


import com.imenez.executor.api.entity.User;
import com.imenez.executor.api.service.UserService;
...
public class UserController {
    ...
    @GetMapping(value = "/getUsersByMultiThreads", produces = "application/json")
